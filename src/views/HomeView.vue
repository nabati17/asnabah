<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Asnabah</h1>
      <div class="py-2">
        <h1
      ...
      <!-- <button
        ...
        <a
  href="https://drive.google.com/uc?export=download&id=1jGfHFnwfvonW7NVqoXznGwSMt5nb2DkU"
  download
...
<div class="flex justify-center md:justify-start fadein-right">
  <img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
    class="w-8/12 md:w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://raw.githubusercontent.com/nabati17/DATAC/main/img/nabati.jpg">
</div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Junior Web Developer", "IT Support", "Informatics Student"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
