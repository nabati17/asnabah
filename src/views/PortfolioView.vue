  ...
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          name: 'Monitoring Gas Amonia',
          imageUrl: 'monitoring',
          status: 'Ammonia Gas Monitoring is designed to provide real-time monitoring of ammonia gas concentration levels in chicken farms',
          tech: 'Laravel 9, Bootstrap',
          github: 'https://github.com/nabati17/monitoring-gas-amonia',
          demo: 'null'
        },
        {
          id: 2,
          ...
          tech: 'React JS',
          github: 'https://github.com/nabati17/Tic-Tac-Toe',
          demo: 'https://tic-tac-toe-asnabah.vercel.app/'
        },
        {
          id: 3,
          name: 'Review Restauran',
          imageUrl: 'restauran',
          status: 'I created a restaurant recommendation website to help users find the best places to eat anytime around them.',
          tech: 'Javascript, Bootstrap',
          github: 'https://github.com/nabati17/Katalog-Restoran-PWA',
          demo: 'https://cataloge-restaurans-asnabah.netlify.app'
        },
        {
          id: 4,
          name: 'Notes Apps',
          imageUrl: 'notes',
          status: 'I created a simple notes website to help users save important ideas and tasks. The website is easy to use and allows users to access records at any time.',
          tech: 'Javascript,React JS, Bootstrap',
          github: 'https://github.com/nabati17/personal-notes-app-react',
          demo: 'https://notes-asnabah.netlify.app/'
        },
        {
          id: 5,
          name: 'Bubur Ayam',
            ...
            <div v-for="item in items" :key="item.id">
              <div
                ...
                <div class="flex h-12 w-12 items-center justify-center p-0 h-full w-full lg:p-0 zoom-in">
                  <img alt="HTML" loading="lazy" decoding="async" data-nimg="1" class="drop-shadow-xl rounded rounded-xl h-56 w-120"
